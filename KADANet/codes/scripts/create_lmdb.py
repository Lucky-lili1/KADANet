...
try:
    ...
    print("无法导入 ProgressBar，将使用替代方案或忽略此功能。")
    pass

# configurations
# img_folder = '/root/shared-storage/KESKPSR-test/codes/data/dataset/Div_Fli4K/DF2K/DF2k/*'  # glob matching pattern
img_folder = "/home/ubuntu/DCLS/DCLS-SR-master/codes/data/dataset/BSD100/LRblur/x2/*"
# lmdb_save_path = '/root/shared-storage/KESKPSR-test/codes/data/dataset/Div_Fli4K/DF2K/DF2K.lmdb'
lmdb_save_path = "/home/ubuntu/DCLS/DCLS-SR-master/codes/data/dataset/BSD100/BSD100_LRblurx2.lmdb"
